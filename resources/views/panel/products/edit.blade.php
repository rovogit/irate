...
@section('title')Редактировать: {{ $product->title }}@endsection
@section('description')Редактировать: {{ $product->title }}@endsection
                            ...
                            <div class="card-inner">
                                <form class="crutch-validate is-alter" action="{{ route('panel.products.user', $product) }}" method="post">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control" id="user_id" name="user_id" value="{{ $product->user_id }}" required>
                                            @if($product->user_id)
